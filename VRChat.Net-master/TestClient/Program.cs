...
namespace TestClient
{
    class Program
    {
        ...
        {
            VRChatApi.VRChatApi api = new VRChatApi.VRChatApi("â…êlë∫í∑Ç´Ç∏Ç´", "7l1wSvNjaDQT");
            ...
            await api.NotificationApi.SendInvite(user.id, "wrld_2efed6e0-54ca-435c-9f30-04c7927ebc8a:79842");
            List<WorldBriefResponse> worlds = await api.WorldApi.Search(WorldGroups.Any);
