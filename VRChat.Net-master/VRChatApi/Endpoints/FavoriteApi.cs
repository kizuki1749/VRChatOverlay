...
namespace VRChatApi.Endpoints
{
    public class FavoriteApi
    {
        ...
        public async Task<List<FavouriteResponse>> GetFavourites(string favouriteType = "avatar", int count = 100)
        {
            HttpResponseMessage response = await Global.HttpClient.GetAsync($"favorites?type={favouriteType}&apiKey={Global.ApiKey}&n=" + count);
